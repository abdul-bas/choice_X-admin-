...
abstract class DashboardPercents {
  static double revenue(double filtered) => DashboardTargets.monthlyRevenue == 0
      ? 0
      : (filtered / DashboardTargets.monthlyRevenue * 100).clamp(0.0, 100.0);
 ...
 static double orders(
  ...
  return ((filtered / totalOrders) * 100).clamp(0.0, 100.0);
}
  ...
  static double activeSellers({
    ...
    final percent = (activeSellers / totalSellers * 100);
